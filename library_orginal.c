#include <windows.h>                   //to access files
#include<stdio.h>
#include<conio.h>
#include <stdlib.h>
...
#include<time.h>                    // gets present time
...
struct books a;
int checkid(char *fname, char *str)
{
FILE *file;
int i = 1,j=1;
char temp[10];
...
void mainmenu1 ()
{
    ...
    gotoxy(20,5);
    printf("\xDB\xDB\xDB\xDB\xB2 1. Suggest Books");
    gotoxy(20,7);
    printf("\xDB\xDB\xDB\xDB\xB2 2. Provide review for books");
    gotoxy(20,9);
    printf("\xDB\xDB\xDB\xDB\xB2 3. Check the best books on the basis of your reviews");
    gotoxy(20,11);
    printf("\xDB\xDB\xDB\xDB\xB2 4. Recently added books");
    gotoxy(20,13);
    printf("\xDB\xDB\xDB\xDB\xB2 5. Change Login");
    gotoxy(20,15);
...
void mainmenu()
{
    ...
    gotoxy(20,15);
    printf("\xDB\xDB\xDB\xDB\xB2 6. View Suggested Book List ");
    gotoxy(20,17);
    printf("\xDB\xDB\xDB\xDB\xB2 7. Edit Book's Record");
    gotoxy(20,19);
    printf("\xDB\xDB\xDB\xDB\xB2 8. Add a new student to library");
    gotoxy(20,21);
    printf("\xDB\xDB\xDB\xDB\xB2 9. Change Login");
    gotoxy(20,23);
